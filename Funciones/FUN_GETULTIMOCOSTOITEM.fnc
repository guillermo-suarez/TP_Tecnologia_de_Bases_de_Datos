create or replace noneditionable function FUN_GETULTIMOCOSTOITEM(pIdObra obra.idobra%type,
...
begin
       ...
       where o.idobra = pIdObra and i.iditem = pIdItem and ic.idredeterminacion =
       (select MAX(icc.idredeterminacion) from itemcosto icc
       where icc.iditem = pIdItem and icc.idobra = pIdObra);
return vCostoItem;
end;
/
